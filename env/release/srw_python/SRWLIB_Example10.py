...
arPrecParSpec = [meth, relPrec, zStartInteg, zEndInteg, npTraj, 0, 0]
...
print('   Starting simulation of Partially-Coherent Wavefront Propagation ... ')
radStokesProp = srwl_wfr_emit_prop_multi_e(elecBeam, magFldCnt, meshInitPartCoh, 1, 0.01, 50000, 5, 20, 
