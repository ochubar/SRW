...
//Assumes Input Intensity in Ph/s/0.1%bw/mm^2, Spectral Attenuation Length in [1/m],
//positions in [m].
...
//variable eNp = dimsize(wSpecInt, 0), eStart = dimoffset(wSpecInt, 0), eStep = dimdelta(wSpecInt, 0)
//make/O/N=(eNp) wAuxSpec001
//SetScale/P x eStart,eStep,"eV", wAuxSpec001
