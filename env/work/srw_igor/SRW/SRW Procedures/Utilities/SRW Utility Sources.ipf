...
if((cmpstr(strSrcSel, "NSLS-II") == 0) %| (cmpstr(strSrcSel, "NSLSII") == 0) %| (cmpstr(strSrcSel, "NSLS-2") == 0) %| (cmpstr(strSrcSel, "NSLS2") == 0))
	...
	$nmGWID[19][0] = "EPU49 (6 m, 15 mm gap) Lin. Horizontal Polar. Mode";	$nmGWID[19][1] = "";										$nmGWID[19][2] = "EPU49G15_BZ_LHc.dat"; 				$nmGWID[19][3] = "0.0492"
	$nmGWID[20][0] = "EPU49 (6 m, 15 mm gap) Helical Mode";				$nmGWID[20][1] = "EPU49G15_BX_HEc.dat"; 				$nmGWID[20][2] = "EPU49G15_BZ_HEc.dat"; 				$nmGWID[20][3] = "0.0492"
	$nmGWID[21][0] = "EPU49 (6 m, 15 mm gap) Lin. Vertical Polar. Mode";	$nmGWID[21][1] = "EPU49G15_BX_LVc.dat"; 				$nmGWID[21][2] = "EPU49G15_BZ_LVc.dat"; 				$nmGWID[21][3] = "0.0492"
	$nmGWID[22][0] = "EPU49 (6 m, 15 mm gap) Lin. Tilted (45 deg.) Polar. Mode";		$nmGWID[22][1] = "EPU49G15_BX_LT45c.dat"; 		$nmGWID[22][2] = "EPU49G15_BZ_LT45c.dat"; 				$nmGWID[22][3] = "0.0492"
	$nmGWID[23][0] = "EPU56 (3 m, 15 mm gap) Lin. Horizontal Polar. Mode";	$nmGWID[23][1] = "";										$nmGWID[23][2] = "EPU56G15_BZ_D34_LHc.dat"; 			$nmGWID[23][3] = "0.0562"
	$nmGWID[24][0] = "EPU56 (3 m, 15 mm gap) Helical Mode";				$nmGWID[24][1] = "EPU56G15_BX_D34_HEc.dat"; 			$nmGWID[24][2] = "EPU56G15_BZ_D34_HEc.dat"; 			$nmGWID[24][3] = "0.0562"
	$nmGWID[25][0] = "EPU56 (3 m, 15 mm gap) Lin. Vertical Polar. Mode";	$nmGWID[25][1] = "EPU56G15_BX_D34_LVc.dat"; 			$nmGWID[25][2] = "EPU56G15_BZ_D34_LVc.dat"; 			$nmGWID[25][3] = "0.0562"
	$nmGWID[26][0] = "EPU56 (3 m, 15 mm gap) Lin. Tilted (45 deg.) Polar. Mode";		$nmGWID[26][1] = "EPU56G15_BX_D34_LT45c.dat"; $nmGWID[26][2] = "EPU56G15_BZ_D34_LT45c.dat"; 		$nmGWID[26][3] = "0.0562"
	$nmGWID[27][0] = "DW100";											$nmGWID[27][1] = ""; 									$nmGWID[27][2] = "DW100CBZ.dat"; 						$nmGWID[27][3] = "1.49253731343284" //"1"
	$nmGWID[28][0] = "2 x DW100 Inline";									$nmGWID[28][1] = ""; 									$nmGWID[28][2] = "Inline2DW100BZ.dat"; 					$nmGWID[28][3] = "0.4" //"1"
	$nmGWID[29][0] = "DW90";											$nmGWID[29][1] = ""; 									$nmGWID[29][2] = "DW90CBZ.dat"; 						$nmGWID[29][3] = "1"
	$nmGWID[30][0] = "2 x DW90 Inline";									$nmGWID[30][1] = ""; 									$nmGWID[30][2] = "Inline2DW90BZ.dat"; 					$nmGWID[30][3] = "0.191754796254"
	$nmGWID[31][0] = "TPW Isolated";										$nmGWID[31][1] = ""; 									$nmGWID[31][2] = "TPWCBZ.dat"; 							$nmGWID[31][3] = "0.108"
