...
6. Find the file "SRW Macro Help.ihf" inside the "SRW:SRW Help" folder. Make a shortcut to this file and move the shortcut in "Igor Pro Folder:Igor Help Files".
