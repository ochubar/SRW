...
#define SUMMING_UP_WAVEFRONTS_ON_DIFF_PHOT_ENERGY_MESH_IS_NOT_IMPLEMENTED 197 + FIRST_XOP_ERR
#define CAN_NOT_PROPAGATE_0D_RAD 198 + FIRST_XOP_ERR
#define BAD_RESIZE_PARAM_FOR_1D_WAVEFRONT 199 + FIRST_XOP_ERR
...
#define PROPAGATION_1D 27 + SRW_WARNINGS_OFFSET
